...
let Maxime =
  {
    ...
    talk =
     { title = "Keynote: User-friendly apps start with dev-friendly tools"
       ...
       video = Some "https://www.youtube.com/watch?v=Ry4qQxU0380"
     }
...
let Krzysztof =
  {
    ...
    talk =
      { title = "Keynote: Future of web development with F#"
        ...
        video = Some "https://www.youtube.com/watch?v=ocLPOEa2DXc"
      }
...
let Evelina =
  {
    ...
    talk =
      { title = "Data visualization with Fable"
        ...
        video = Some "https://youtu.be/YpX5yhGrJkw"
      }
...
let Tomasz =
  {
    ...
    talk =
      { title = "Build a game with Fable in 45 minutes"
        ...
        video = Some "https://youtu.be/uYjrwfWOflg"
      }
