...
let François =
  {
    ...
    bio = Some "François is neither the best devops nor the best developer out here. But having played with systems and programming for nearly 2 decades, he's prompt to try new stacks and see if all that can help other people in their daily chores. These days when he's not deploying Fable and F# all over the world for his clients, he's teaching and helping young people discover the joys of technology. Sometimes he also explores caves. With Ropes. And bats. A modern Rick Dangerous?"
